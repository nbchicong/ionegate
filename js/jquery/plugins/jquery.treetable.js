...
(function() {
  ...
  Node = (function() {
    ...
    Node.prototype.reveal = function() {
      if (this.parentId != null && this.parentNode()) {
  ...
  methods = {
    init: function(options) {
      ...
      settings = $.extend({
        ...
        expandable: false,
        expanderTemplate: "<a href='javascript:;'>&nbsp;</a>",
        indent: 19,
    ...
    removeNode: function(id)  {
      ...
      var siblings = (node.parentNode()) ? node.parentNode().children : [node];

      // remove branch and current node
      this.data("treetable").unloadBranch(node);
      node.row.remove();
      ...
      // remove toggle icon if no more children exist
      if (siblings.length === 0 && node.parentNode()) {
