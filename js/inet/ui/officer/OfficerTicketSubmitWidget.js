// #PACKAGE: officer-ticket-submit
// #MODULE: TicketSubmitWidget
$(function () {
  iNet.ns('iNet.ui.onegate.officer');
//==========================
  iNet.ui.onegate.officer.TicketSubmitWidget = function (config) {
    var __config = config || {};
    iNet.apply(this, __config);// apply configuration
    this.id = this.id || 'ticket-submit-widget';
    iNet.ui.onegate.officer.TicketSubmitWidget.superclass.constructor.call(this);
  ...
  iNet.extend(iNet.ui.onegate.officer.TicketSubmitWidget, iNet.ui.onegate.OnegateWidget, {
    getMask: function () {
      return this.getEl();
    },
    check: function () {
