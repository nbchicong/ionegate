// #PACKAGE: officer-ticket-list-unit
// #MODULE: TicketListUnit
$(function () {
  iNet.ns('iNet.ui.onegate.officer');
  iNet.ui.onegate.officer.TicketListUnit = function (config) {
    this.id = 'ticket-list';
    var __config = config || {};
    iNet.apply(this, __config);
    this.mode = this.mode || 'receiver';
    this.print = this.print || false;
    iNet.ui.onegate.officer.TicketListUnit.superclass.constructor.call(this);
    ...
    var insertTicketToList = function (item, prepend) {
      ...
      __html += '<div class="wrapper" style="padding-left: 15px;">';
...
//      __html += '</div>';
  ...
  iNet.extend(iNet.ui.onegate.officer.TicketListUnit, iNet.ui.onegate.OnegateWidget, {
    getStore: function () {
      return this.store;
    },
