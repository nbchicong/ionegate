// #PACKAGE: officer-ticket-self-unit-main
// #MODULE: OfficerTicketSelfUnitMainService
$(function() {
  var $window = $(window);
  var ticketList = new iNet.ui.onegate.officer.TicketListUnit({
    allowCreate: false,
    mode: 'officer',
    print: true,
    url: iNet.getXUrl('onegate/office/unitticketreceiver')
  });
  var ticketView = new iNet.ui.onegate.officer.TicketViewUnit({
    allowCreate: false,
    allowMatcher: false,
    officer: true
  });
