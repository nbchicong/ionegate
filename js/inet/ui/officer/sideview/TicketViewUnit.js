// #PACKAGE: officer-ticket-view-unit
// #MODULE: TicketViewUnit
$(function () {
  iNet.ns('iNet.ui.onegate.officer');
  iNet.ui.onegate.officer.TicketViewUnit = function (config) {
    var __config = config || {};
    ...
    iNet.ui.onegate.officer.TicketViewUnit.superclass.constructor.call(this);
    var me = this;
              ...
              fn: function () {
                ...
                if (!iNet.isEmpty(__data.ticket)) {
                  ...
                  $.postJSON(__url, __data, function (result) {
                    var __result = result || {};
                    me.showMessage('success', 'Hồ sơ', 'Hồ sơ đã được trả cho công dân');
...
//    }, {mask: this.getMask(), msg: iNet.resources.ajaxLoading.saving});
  ...
  iNet.extend(iNet.ui.onegate.officer.TicketViewUnit, iNet.ui.onegate.OnegateWidget, {
    getMask: function(){
      return this.getEl();
    },
    ...
    setProcedureName: function (name) {
      ...
      this.$lblProcedure.text('Thông tin chi tiết');
    },
...
//        FormUtils.showButton(me.$toolbar.NOTIFY_PAYMENT, __isExist && __isTicket && __isReceiver);
        ...
        //}
        //me.$profile.main.find('input,select,textarea').prop('enabled', true);
