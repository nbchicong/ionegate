// #PACKAGE: officer-ticket-view
// #MODULE: TicketView
$(function () {
  iNet.ns('iNet.ui.onegate.officer');
  iNet.ui.onegate.officer.TicketView = function (config) {
    var __config = config || {};
    ...
    iNet.ui.onegate.officer.TicketView.superclass.constructor.call(this);
    var me = this;
  ...
  iNet.extend(iNet.ui.onegate.officer.TicketView, iNet.ui.onegate.OnegateWidget, {
    getMask: function(){
      return this.getEl();
    },
