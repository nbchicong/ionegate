// #PACKAGE: officer-ticket-return
// #MODULE: TicketReturnWidget
$(function () {
  iNet.ns('iNet.ui.onegate.officer');
  //==========================
  iNet.ui.onegate.officer.TicketReturnWidget = function (config) {
    var __config = config || {};
    ...
    iNet.ui.onegate.officer.TicketReturnWidget.superclass.constructor.call(this) ;
    var me = this;
  ...
  iNet.extend(iNet.ui.onegate.officer.TicketReturnWidget, iNet.ui.onegate.OnegateWidget, {
