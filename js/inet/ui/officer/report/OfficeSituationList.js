// #PACKAGE: officer-report-office-situation-list
// #MODULE: OfficeSituationList
/**
...
$(function () {
  ...
  iNet.ui.onegate.officer.OfficeSituationList = function (config) {
    this.id = 'officer-report-situation-list';
    var __config = config || {};
    iNet.apply(this, __config);
    iNet.ui.onegate.officer.OfficeSituationList.superclass.constructor.call(this);
    this.allowCreate = !iNet.isEmpty(this.allowCreate) ? this.allowCreate : false;
    this.$toolbar = {
      CREATE: $('#officer-report-situation-list-btn-create'),
      DELETE: $('#officer-report-situation-list-btn-delete')
    };
    ...
    this.$gridBody = $('#officer-report-situation-grid');
    this.$nodata = $('#message-list-no-data');

    this.$listContent = $('#div-message-list-dp-content');
    this.$keyword = $('#officer-report-situation-basic-search-txt-keyword');
                ...
                if (!iNet.isEmpty(__data.reportID)) {
                  $.postJSON(me.url.del, __data, function (result) {
                    ...
                    if (__result.type !== 'ERROR') {
                      me.search();
                      me.showMessage('success', iNet.resources.onegate.officer.report.delete_title, iNet.resources.onegate.officer.report.delete_success);
                      me.fireEvent('deleted', __result);
                    } else {
                      me.showMessage('error', iNet.resources.onegate.officer.report.delete_title, iNet.resources.onegate.officer.report.delete_error);
                    }
  ...
  iNet.extend(iNet.ui.onegate.officer.OfficeSituationList, iNet.ui.onegate.OnegateWidget, {
    getStore: function () {
      return this.store;
    },
    ...
    search: function () {
      var __params = {
        ...
        group:'REPORT_OFFICER_SITUATION'
      };
