// #PACKAGE: officer-report-office-situation
// #MODULE: OfficeSituation
/**
...
$(function () {
  ...
  iNet.ui.onegate.officer.OfficeSituation = function (config) {
    var __config = config || {};
    iNet.apply(this, __config);
    this.id = this.id || 'officer-report-situation-view';

    iNet.ui.onegate.officer.OfficeSituation.superclass.constructor.call(this);
    var me = this;
    ...
    this.$actionToolbar = $('#officer-report-situation-action-toolbar');
    ...
    this.$toolbar = {
      CREATE: $('#officer-report-situation-create-btn'),
      DELETE: $('#officer-report-situation-delete-btn'),
      DOWNLOAD: $('#officer-report-situation-download-btn'),
      PREV: $('#officer-report-situation-btn-previous'),
      NEXT: $('#officer-report-situation-btn-next'),
      VIEW: $('#officer-report-situation-view-btn'),
      SAVE: $('#officer-report-situation-save-btn'),
      SAVE_OK: $('#widget-report-modal-ok')
    };

    this.$input = {
      fromdate: $('#officer-report-situation-from-dtp'),
      todate: $('#officer-report-situation-to-dtp'),
    ...
    this.validation = new iNet.ui.form.Validate({
      ...
      rules: [{
        ...
        validate: function (v) {
          if (iNet.isEmpty(v))
            return iNet.resources.onegate.officer.report.fromdate_not_empty;
        }
      },{
        id: this.$input.todate.prop("id"),
        validate: function (v) {
          if (iNet.isEmpty(v))
            return iNet.resources.onegate.officer.report.todate_not_empty;
        }
      }]
    });
  ...
  iNet.extend(iNet.ui.onegate.officer.OfficeSituation, iNet.ui.onegate.OnegateWidget, {
    ...
    getModule: function () {
      return this.module || 'REPORT_OFFICER_SITUATION';
    },
    getUuid: function () {
      return this.uuid;
    },
