// #PACKAGE: ionegate-admin-wf-design-detail
// #MODULE: AdminWorkflowDesignDetailService
$(function () {
  iNet.ns('iNet.ui.onegate.radmin');
  iNet.ui.onegate.admin.WorkflowDesignDetailService = function (config) {
    this.url = {
    ...
    this.save = function (data) {
      ...
      $.postJSON(url, data, function (result) {
        ...
        if (!iNet.isEmpty(__result.uuid)) {
          ...
          self.showMessage('success', iNet.resources.message["note"], getText("Quy trình đã được tạo thành công"));
  ...
  iNet.extend(iNet.ui.onegate.admin.WorkflowDesignDetailService, iNet.ui.onegate.OnegateWidget, {
    view: function (data) {
      this._view(data);
    }
  });
