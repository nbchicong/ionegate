// #PACKAGE: onegate-superadmin-report-procedures-service
...
$(function () {
  var contentWg = null;
  var searchWg = new iNet.ui.superadmin.report.procedures.SearchWidget({
    module: "REPORT_PROCEDURES"
  });
  ...
  var getContentWidget = function(parent){
    if (!contentWg) {
      contentWg = new iNet.ui.superadmin.report.procedures.ContentWidget({
        module: "REPORT_PROCEDURES"
      });
