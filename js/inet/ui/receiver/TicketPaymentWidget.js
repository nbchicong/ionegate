// #PACKAGE: receiver-ticket-payment
// #MODULE: TicketPaymentWidget
$(function () {
  iNet.ns('iNet.ui.onegate.receiver');
  //==========================
  iNet.ui.onegate.receiver.PaidDialog = function(config) {
    var __config = config || {};
  ...
  iNet.extend(iNet.ui.onegate.receiver.PaidDialog, iNet.Component, {
    getEl: function(){
      return this.$element;
    },
    show : function() {
  ...
  iNet.ui.onegate.receiver.TicketPaymentWidget = function (config) {
    var __config = config || {};
    iNet.apply(this, __config);// apply configuration
    this.id = this.id || 'ticket-payment-widget';
    iNet.ui.onegate.receiver.TicketPaymentWidget.superclass.constructor.call(this) ;
  ...
  iNet.extend(iNet.ui.onegate.receiver.TicketPaymentWidget, iNet.ui.onegate.OnegateWidget, {
    getTicketId: function(){
      return this.ticketId;
    },
    getGrid: function(){
