// #PACKAGE: receiver-report-receive-situation-main
// #MODULE: ReceiveSituationMain
/**
...
$(function() {
  var $window = $(window);
  var reportList = new iNet.ui.onegate.receiver.ReceiveSituationList({
    allowCreate: true
  });
  var reportView = new iNet.ui.onegate.receiver.ReceiveSituation({
    allowCreate: true,
    allowMatcher: true
  });

  var module = 'REPORT_RECEIVER_SITUATION';
