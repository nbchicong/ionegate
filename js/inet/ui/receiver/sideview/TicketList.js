...
$(function () {
  ...
  iNet.ui.onegate.receiver.TicketList = function (config) {
    this.id = 'ticket-list';
    var __config = config || {};
    iNet.apply(this, __config);
    this.mode = this.mode || 'receiver';
    this.print = this.print || false;
    iNet.ui.onegate.receiver.TicketList.superclass.constructor.call(this);
    ...
    var insertTicketToList = function (item, prepend) {
      ...
      __html += String.format('<span class="date timeago" data-time="{0}" title="{1}">{2}</span>', __item.received, new Date(__item.received).format('H:i:s d/m/Y'), $.timeago(__item.received));
  ...
  iNet.extend(iNet.ui.onegate.receiver.TicketList, iNet.ui.onegate.OnegateWidget, {
    getStore: function () {
      return this.store;
    },
